...
use crate::services::eventbus::EventBus;
                ...
                match msg.message_type {
                    MsgTypes::Users => {
                        ...
                        self.users = users_from_message
                            ...
                            .map(|u| UserProfile {
                                name: u.into(),
                                avatar: format!("https://avatars.dicebear.com/api/adventurer-neutral/{}.svg", u).into(),
                            })
                            .collect();
                        return true;
                    }
                    MsgTypes::Message => {
                        let message_data: MessageData = serde_json
                            ::from_str(&msg.data.unwrap())
                            .unwrap();
